...
**Implication:** Collections stay relevant without maintenance. Create a collection `all: ["active"], none: ["archived"]` and it remains correct even as new objects are added. Users think in terms of logical filters rather than folder hierarchies.
