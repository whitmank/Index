...
import type { AttributeKind, DataEntry } from "@index/database/types";

/** What a freshly-chosen kind's value starts as. */
export function blankFieldValue(kind: AttributeKind): DataEntry["value"] {
  return kind === "list" ? [] : "";
}

/** Whether a value carries nothing — the empty string, or no entries. */
export function isBlankFieldValue(value: DataEntry["value"]): boolean {
...
export function coerceFieldValue(value: DataEntry["value"], kind: AttributeKind): DataEntry["value"] {
