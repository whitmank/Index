...
#ifndef FINDERSYNCEXTENSION_SWIFT_H
#define FINDERSYNCEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FinderSyncExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSMenu;
SWIFT_CLASS("_TtC19FinderSyncExtension19FinderSyncExtension")
@interface FinderSyncExtension : FIFinderSync
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (NSMenu * _Nullable)menuForMenuKind:(FIMenuKind)menuKind SWIFT_WARN_UNUSED_RESULT;
- (IBAction)addToIndex:(id _Nullable)sender;
@end
